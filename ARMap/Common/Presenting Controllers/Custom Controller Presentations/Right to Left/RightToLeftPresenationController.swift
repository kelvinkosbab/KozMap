...
class RightToLeftPresentationController : CustomPresentationController {
  ...
  override func presentationTransitionWillBegin() {
    ...
    self.presentationInteractiveTransition = DragRightDismissInteractiveTransition(interactiveViews: self.allPresentationInteractiveViews, delegate: self)
  }
  ...
  override func presentationTransitionDidEnd(_ completed: Bool) {
    ...
    self.dismissInteractiveTransition = DragRightDismissInteractiveTransition(interactiveViews: self.allDismissInteractiveViews, delegate: self)
  }
