...
class PlacemarkNode : VirtualObject {
  ...
  convenience init(savedLocation: SavedLocation, primaryName: String? = nil, distanceText: String? = nil, unitText: String? = nil, beamColor: UIColor = .kozRed, beamTransparency: CGFloat = 0.5) {
